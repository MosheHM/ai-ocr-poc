...
if (-not (Test-Path local.settings.json)) {
    ...
    Write-Host "[OK] local.settings.json created" -ForegroundColor Green
...
if ($dockerAvailable) {
    ...
    Write-Host "[OK] Azurite started (Docker)" -ForegroundColor Green
}
else {
    ...
    Write-Host "[OK] Azurite started" -ForegroundColor Green
}
...
if (-not $azCliAvailable) {
    ...
    try {
        ...
        Write-Host "  (container validation failed or already exists)" -ForegroundColor Gray
    }
    ...
    try {
        ...
        Write-Host "  (queue validation failed or already exists)" -ForegroundColor Gray
    }
